...
| --- | --- | --- | ---: | --- | --- |
| `hopper` | `h100-80g` | NVIDIA H100 80GB HBM3 | 36 | `behavioral_only`=6, `bounded`=8, `conditionally_identified`=4, `direct`=6, `underconstrained`=5, `uniquely_identified`=7 | [probes](hopper/probes-h100-80g.md) |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `h100-80g` | 16 | 2.3606 | 45.2683 | 927.239 | 24.4648 | 0.1598 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `h100-80g` | — | 70.6099 | 329.514 | 32 | 29.0146 |
...
| --- | ---: | ---: | ---: | ---: |
| `h100-80g` | uniform | 3064.33 | 723.672 | 37.46 |

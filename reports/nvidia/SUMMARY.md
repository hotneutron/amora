...
| `volta` | `v100-32g` | Tesla V100-SXM2-32GB | 36 | `behavioral_only`=8, `bounded`=7, `conditionally_identified`=3, `direct`=5, `underconstrained`=3, `uniquely_identified`=7, `unsupported`=3 | [probes](volta/probes-v100-32g.md) |
...
| sku | arithmetic_latency.dependent_chain (cycles_per_op) | arithmetic_throughput.independent_chains (cycles_per_op) | scheduler_policy.mixed_issue | scheduler_policy.ready_warps (warps) | topology.persistent_cta (blocks) |
| --- | ---: | ---: | ---: | ---: | ---: |
| `v100-32g` | 4.376 | 2.1097 | single_issue_like | 12 | 13 |
...
| sku | interconnect.address_mapping | interconnect.injection_rate (GB/s) | tma_copy.analyze | tma_copy.async_copy_latency | tma_copy.tma_transfer_sweep |
| --- | ---: | ---: | ---: | ---: | ---: |
| `v100-32g` | periodic_camping | 869.47 | — | — | — |

...
| --- | --- | ---: | --- | --- | --- |
| `h100-80g` | NVIDIA H100 80GB HBM3 | 36 | `behavioral_only`=6, `bounded`=9, `conditionally_identified`=4, `direct`=6, `underconstrained`=4, `uniquely_identified`=7 | 2026-06-24T10:58Z | [probes](probes-h100-80g.md) |

## `h100-80g` outcomes

| probe_id | mode | evidence_tier | fit_status | measurement |
| --- | --- | --- | --- | --- |
| [topology.device_attributes](probes-h100-80g.md#topologydevice_attributes) | `metadata` | `direct_metadata` | `direct` | _object_ (device_index, device_name, driver_version, published_facts, uuid) |
...
| [l1_cache.pointer_chase](probes-h100-80g.md#l1_cachepointer_chase) | `kernel` | `timing_direct` | `direct` | 70.6091 cycles |
...
| [register_file.register_bank_sweep](probes-h100-80g.md#register_fileregister_bank_sweep) | `kernel` | `timing_direct` | `bounded` | 16 accumulators |
...
| [l2_cache.pointer_chase](probes-h100-80g.md#l2_cachepointer_chase) | `kernel` | `timing_direct` | `bounded` | 329.901 cycles |
...
| [global_memory.row_policy_sweep](probes-h100-80g.md#global_memoryrow_policy_sweep) | `kernel` | `timing_direct` | `bounded` | 1.75543 ratio |
...
| [synchronization.fence_latency](probes-h100-80g.md#synchronizationfence_latency) | `kernel` | `timing_direct` | `conditionally_identified` | 928.961 cycles |
| [tma_copy.async_copy_latency](probes-h100-80g.md#tma_copyasync_copy_latency) | `kernel` | `timing_direct` | `conditionally_identified` | 723.234 cycles |
...
| [interconnect.injection_rate](probes-h100-80g.md#interconnectinjection_rate) | `kernel` | `timing_direct` | `bounded` | 3075 GB/s |
